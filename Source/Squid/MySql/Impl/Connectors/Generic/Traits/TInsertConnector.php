...
trait TInsertConnector
{
	...
	{
		return $this->getInsertConnector()->insertRow($row, $ignore);
	}
	...
	{
		return $this->getInsertConnector()->insertAll($rows, $ignore);
	}
	...
	{
		return $this->getInsertConnector()->insertAllIntoFields($fields, $rows, $ignore);
	}
}